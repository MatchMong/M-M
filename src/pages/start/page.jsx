...
export function MainPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-[#DCE2FF] to-[#F4F9FF] gap-8">
            <div className="w-[588px] h-[230px] flex items-center justify-center mb-[-20px]">
